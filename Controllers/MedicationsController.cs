...
namespace MEDIplan.Controllers
{
    public class MedicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicationId,Name,SubstanceAmount")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicationId,Name,SubstanceAmount")] Medication medication)
        {
